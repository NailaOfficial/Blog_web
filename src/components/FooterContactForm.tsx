...
export default function FooterContactForm() {
  return (
    <form className="bg-gray-900 px-6 sm:px-8 lg:px-12 py-6 w-full md:w-1/2 ">
      <div className="w-full">
        ...
        <button className="px-12 py-3 text-xl font-semibold border-2 border-dark  text-light hover:text-dark uppercase transition-all duration-150 ease-linear bg-dark hover:bg-light shadow-md shadow-red-600 rounded-lg block mx-auto">
          Submit
        </button>
      </div>
    </form>
